// Provided by:   ____________Songren Zhao__________
// Email Address: ____________szhao003@citymail.cuny.edu________
// FILE: sequence2.h
...
namespace main_savitch_4
{
    ...
    private:
        value_type *array_ptr;
        size_type currentIdx, used, capacity;
    };
}
